...
pub fn get_proposal_data_controller(url: &str) {
    ...
    let success_to_download_html_message = ConsoleMessager::new(
    ...
    let success_to_get_information_message = ConsoleMessager::new(
     ...
     */
    let image_path = download_og_image(&proposal.image_url, &proposal.title);
    let og_image_message = ConsoleMessager::new(
